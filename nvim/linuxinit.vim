...
" To Go Out From Terminal Mode With Esc
tnoremap <Esc> <C-\><C-n>
...
"Git Command In Vim Session
Plug 'tpope/vim-fugitive'

"Scrolling Through File CTRL U and CTRL D
...
" Use `[g` and `]g` to navigate iagnostics
...
let g:WebDevIconsDefaultFileSymbolColor = s:blue " sets the color for files that did not match any ruled
